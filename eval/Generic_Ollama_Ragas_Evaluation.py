...
async def evaluate_finance_chatbot_ollama():
    print("Starting Ollama Mistral Finance Chatbot evaluation with RAGAS metrics...")
    ...
    persist_dir = "./chroma_generic_ollama_ragas_eval"
    ...
    with open("generic_ollama_ragas_evaluation2.json", "w") as f:
    ...
    print("Detailed results saved to generic_ollama_ragas_evaluation2.json")


asyncio.run(evaluate_finance_chatbot_ollama())